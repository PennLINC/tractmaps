#------------------------------------------------------------------------------------------------
# --- Sensitivity Analysis: Spatial embedding with geodesic distances ---
#------------------------------------------------------------------------------------------------

# This script plots the relationship between the S-A range of tracts and their mean geodesic distance.
...
# Load pre-computed geodesic tract distances
tract_means = pd.read_csv(f'{euc_dist_dir}/tract_geodesic_distances_means.csv')
tract_dist = pd.read_csv(f'{euc_dist_dir}/tract_geodesic_distances_pairwise.csv')
distance_column = 'Mean_Geodesic_Distance'
distance_label = 'Geodesic distance'
distance_filename = 'geodesic'

print(f"Using geodesic distances")
...
# ------------------------------------------------------------------------------------------------
# --- Plot full tract set with geodesic distances ---
# ------------------------------------------------------------------------------------------------
...
for tract in all_tracts:
    ...
    tract_labels.append(tract.replace('_', ' '))  # Format names for display
...
results_summary = pd.DataFrame({
    'analysis': ['full_tract_set_geodesic'],
