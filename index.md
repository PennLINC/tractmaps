...
- [I. Project information](#project-information)
- [II. Directory structure](#directory-structure)
- [III. Code documentation](#code-documentation)
...
- `check_subjects_<dataset>.sh` — finds which subjects were in the original `<dataset>_subject_list.txt` (i.e., they have a qsirecon zip file) but don’t have a TSV output file. This should be 0 (all were unzipped correctly).
